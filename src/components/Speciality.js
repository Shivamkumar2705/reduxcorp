    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
      {specialityData.map((card, index) => (
        <motion.div
          ...
          className="group bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-xl hover:shadow-purple-700/30 transition-all duration-500 hover:bg-white/10 min-h-[350px]" // Adjust height here
        >
